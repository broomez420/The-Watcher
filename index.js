...
bot.on('ready', () => {
  setInterval(async ()=>{
      ...
      let textList = ['How to Manage','lurking','Learning','Protecting 8 servers','https://discord.gg/mNNsfsg','keeping 6000+ users safe','reaching 1.5 mil users','updating database...','scanning database']
