...
bot.on('ready', () => {
  setInterval(async ()=>{
      ...
      let textList = ['How to Manage','lurking','Learning','Protecting 9 servers','discord.gg/mNNsfsg','Reporting UIDs','Scanning Servers...','keeping 8000 users safe','reaching 1.6 mil users','updating database...','scanning database...']
